...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 825, 566))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.scrollAreaWidgetContents)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.hora_inicio_in = QtWidgets.QTimeEdit(self.scrollAreaWidgetContents)
        self.hora_inicio_in.setMaximumSize(QtCore.QSize(55, 16777215))
        ...
        self.hora_fin_in.setMaximumSize(QtCore.QSize(55, 16777215))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_4.setPlaceholderText(_translate("MainWindow", "Subtema"))
        self.nombre_tema_label.setText(_translate("MainWindow", "Nombre"))
        self.salon_label.setText(_translate("MainWindow", "Salón"))
        self.dia_label.setText(_translate("MainWindow", "Dia"))
        self.hora_inicio_label.setText(_translate("MainWindow", "Hora inicio"))
        self.horario_label.setText(_translate("MainWindow", "Horario"))
        self.color_label.setText(_translate("MainWindow", "Color"))
        self.num_tema_label.setText(_translate("MainWindow", "Número"))
        self.pushButton.setText(_translate("MainWindow", "PushButton"))
        self.materia_label.setText(_translate("MainWindow", "Materia"))
        self.tema_label.setText(_translate("MainWindow", "Tema"))
        self.duracion_tema_label.setText(_translate("MainWindow", "Duracion"))
        self.hora_fin_label.setText(_translate("MainWindow", "Hora fin"))
